...
# Keep JSON order preserved exactly as requested
...
def format_post_object(post, position=None):
    ...
    # Use Raw Typename (GraphVideo, GraphSidecar, GraphImage)
    ...
    obj = {
        ...
        "iso_date": get_ist_date(post.date_local), # FIXED: Returns IST
        "thumbnail": post.url
    }
...
def instagram_api():
    ...
    try:
        ...
        if username:
            ...
            posts_list = []
            try:
                # FIXED: Fetches 8 posts to ensure post #7 appears
        ...
        # ==========================
            ...
            # RESTORED: Exact Requested Structure with metadata
            response = {
                "search_metadata": {
                    "id": f"req_{shortcode}",
                    "status": "Success",
